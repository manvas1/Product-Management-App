...
//        System.out.println(p);
        ...
        //service.getProductWithText("black").forEach(p -> System.out.println(p));
        service.getProductByPlace("shelf").forEach(p -> System.out.println(p));
        //service.getOutOfWarrantyProducts().forEach(p -> System.out.println(p));
        service.getProduct("Logi Mouse").ifPresent(p -> System.out.println(p));
    }
}
